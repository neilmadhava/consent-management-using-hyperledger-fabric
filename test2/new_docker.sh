...
docker-compose -f docker-compose-cli2.yaml up -d orderer.example.com ca0 ca1 ca2 peer0.airport.example.com peer0.ccd.example.com peer0.users.example.com cli
